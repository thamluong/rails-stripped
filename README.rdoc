...
1. Run rake secret.
2. Set `export SECRET_KEY_BASE=generated secret` in ~/.profile.

export STRIPE_PUBLISHABLE_KEY='stripe key'
...
](https://rubyplus.com/articles/621 'How to Install Alpha SSL certificate using Moonshine for Rails 4.1
